...
# jk clothes
# PRE_DEFINE_CATEGORIES = {"none":0,"red":1,"other":2,"blue":3,"white":4,"black":5,"green":6}
# PRE_DEFINE_CATEGORIES = {"front":0,"back":1}
# jk box_label
# PRE_DEFINE_CATEGORIES = {"1":0,"2":1,"3":2,"4":3,"5":4}
# PRE_DEFINE_CATEGORIES = {"1":0,"2":1,"3":2,"0":3}
# PRE_DEFINE_CATEGORIES = {"4":0,"5":1}
# PRE_DEFINE_CATEGORIES = {"11": 0, "13": 1, "18": 2, "22": 3}


# jk moneybag
# PRE_DEFINE_CATEGORIES = {"1":0,"2":1,"3":2,"4":3}
# PRE_DEFINE_CATEGORIES = {"1":0,"5":1,"6":2}
# PRE_DEFINE_CATEGORIES = {"moneybag":0,"box":1}
# jk car
# PRE_DEFINE_CATEGORIES = {"car":0,'opendoor':1,'closedoor':2}

# jcp warninglight
# PRE_DEFINE_CATEGORIES = {"light":0,"flicker":1,"dark":2}
# jcp switch
# PRE_DEFINE_CATEGORIES = {"open":0,"close":1}
# jcp safety_clothes
# PRE_DEFINE_CATEGORIES ={"head0":0,"head1":1,"head2":2,"clothes0":3,"clothes1":4,"clothes2":5}
# jcp safety_rope
PRE_DEFINE_CATEGORIES = {"clothes": 0, "rope": 1}
...
if __name__ == '__main__':
    ...
    json_file = r'E:\dataset\jcp_data\rope_clothes\COCO\val2014\annotations_all/instances_val2014.json'
    convert(xml_list, xml_dir, json_file)
    for xml_file in xml_list:
        img_name = xml_file[:-4] + '.jpg'
        shutil.copy(os.path.join(root_path, 'JPEGImages', img_name),
                    os.path.join(coco_path, 'val2014\images_all', img_name))
    # train data
    xml_list = xml_labels[split_point:]
    json_file = r'E:\dataset\jcp_data\rope_clothes\COCO\train2014\annotations_all/instances_train2014.json'
    convert(xml_list, xml_dir, json_file)
    for xml_file in xml_list:
        img_name = xml_file[:-4] + '.jpg'
        shutil.copy(os.path.join(root_path, 'JPEGImages', img_name),
                    os.path.join(coco_path, 'train2014\images_all', img_name))
