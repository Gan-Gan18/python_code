...
def revise_json(ori_json_file, revise_json_file):
    ...
    new_imagePath_1 = new_imagePath.split(' ')[0] + new_imagePath.split(' ')[1]
    # print(new_imagePath_1)
    # basename = os.path.basename(ori_json_file)
    # new_imagePath = basename.split('.')[0]
    json_data["imagePath"] = new_imagePath_1 + '.jpg'
...
if __name__ == '__main__':
    ori_filePath = r'E:\dataset\RMB_data\BaiGuo\Lable\test\1/'
    revise_filePath = r'E:\dataset\RMB_data\BaiGuo\Lable\test\2/'
